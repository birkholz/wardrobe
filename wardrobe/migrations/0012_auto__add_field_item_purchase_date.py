...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.purchase_date'
        db.add_column(u'wardrobe_item', 'purchase_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.purchase_date'
        db.delete_column(u'wardrobe_item', 'purchase_date')
