...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.purchase_date'
        db.alter_column(u'wardrobe_item', 'purchase_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Item.purchase_date'
        db.alter_column(u'wardrobe_item', 'purchase_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
