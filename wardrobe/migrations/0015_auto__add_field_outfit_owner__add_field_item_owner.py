...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Outfit.owner'
        db.add_column(u'wardrobe_outfit', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.owner'
        db.add_column(u'wardrobe_item', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Outfit.owner'
        db.delete_column(u'wardrobe_outfit', 'owner_id')

        # Deleting field 'Item.owner'
        db.delete_column(u'wardrobe_item', 'owner_id')
