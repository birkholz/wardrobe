...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Outfit.owner'
        db.alter_column(u'wardrobe_outfit', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']))

        # Changing field 'Item.owner'
        db.alter_column(u'wardrobe_item', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Outfit.owner'
        db.alter_column(u'wardrobe_outfit', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Item.owner'
        db.alter_column(u'wardrobe_item', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
