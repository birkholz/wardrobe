...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.category'
        db.alter_column(u'wardrobe_item', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wardrobe.Category']))
    ...
    models = {
        ...
        u'wardrobe.item': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'items'", 'null': 'True', 'to': u"orm['wardrobe.Category']"}),
