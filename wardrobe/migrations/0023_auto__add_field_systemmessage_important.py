...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SystemMessage.important'
        db.add_column(u'wardrobe_systemmessage', 'important',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SystemMessage.important'
        db.delete_column(u'wardrobe_systemmessage', 'important')
