...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OutfitWornDate.date'
        db.alter_column(u'wardrobe_outfitworndate', 'date', self.gf('django.db.models.fields.DateField')())
        # Adding unique constraint on 'OutfitWornDate', fields ['outfit', 'date']
        db.create_unique(u'wardrobe_outfitworndate', ['outfit_id', 'date'])


        # Changing field 'ItemWornDate.date'
        db.alter_column(u'wardrobe_itemworndate', 'date', self.gf('django.db.models.fields.DateField')())
        # Adding unique constraint on 'ItemWornDate', fields ['item', 'date']
        db.create_unique(u'wardrobe_itemworndate', ['item_id', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'ItemWornDate', fields ['item', 'date']
        db.delete_unique(u'wardrobe_itemworndate', ['item_id', 'date'])

        # Removing unique constraint on 'OutfitWornDate', fields ['outfit', 'date']
        db.delete_unique(u'wardrobe_outfitworndate', ['outfit_id', 'date'])


        # Changing field 'OutfitWornDate.date'
        db.alter_column(u'wardrobe_outfitworndate', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'ItemWornDate.date'
        db.alter_column(u'wardrobe_itemworndate', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
