...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPrefs.currency'
        db.add_column(u'wardrobe_userprefs', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=3),
                      keep_default=False)

        # Adding field 'UserPrefs.time_zone'
        db.add_column(u'wardrobe_userprefs', 'time_zone',
                      self.gf('timezone_field.fields.TimeZoneField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPrefs.currency'
        db.delete_column(u'wardrobe_userprefs', 'currency')

        # Deleting field 'UserPrefs.time_zone'
        db.delete_column(u'wardrobe_userprefs', 'time_zone')
