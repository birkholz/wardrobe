...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPrefs.date_format'
        db.add_column(u'wardrobe_userprefs', 'date_format',
                      self.gf('django.db.models.fields.CharField')(default='MM/DD/YYYY', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPrefs.date_format'
        db.delete_column(u'wardrobe_userprefs', 'date_format')
