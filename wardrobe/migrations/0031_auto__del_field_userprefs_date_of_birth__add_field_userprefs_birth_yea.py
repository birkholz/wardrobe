...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserPrefs.date_of_birth'
        db.delete_column(u'wardrobe_userprefs', 'date_of_birth')

        # Adding field 'UserPrefs.birth_year'
        db.add_column(u'wardrobe_userprefs', 'birth_year',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserPrefs.date_of_birth'
        db.add_column(u'wardrobe_userprefs', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserPrefs.birth_year'
        db.delete_column(u'wardrobe_userprefs', 'birth_year')
