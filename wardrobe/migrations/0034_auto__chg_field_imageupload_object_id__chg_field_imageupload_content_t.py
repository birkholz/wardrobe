...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageUpload.object_id'
        db.alter_column(u'wardrobe_imageupload', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'ImageUpload.content_type'
        db.alter_column(u'wardrobe_imageupload', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ImageUpload.object_id'
        raise RuntimeError("Cannot reverse this migration. 'ImageUpload.object_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ImageUpload.object_id'
        db.alter_column(u'wardrobe_imageupload', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # User chose to not deal with backwards NULL issues for 'ImageUpload.content_type'
        raise RuntimeError("Cannot reverse this migration. 'ImageUpload.content_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ImageUpload.content_type'
        db.alter_column(u'wardrobe_imageupload', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        u'wardrobe.imageupload': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': u"orm['auth.User']"}),
