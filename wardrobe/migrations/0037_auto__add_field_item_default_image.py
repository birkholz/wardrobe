...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.default_image'
        db.add_column(u'wardrobe_item', 'default_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wardrobe.ImageUpload']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.default_image'
        db.delete_column(u'wardrobe_item', 'default_image_id')
    ...
    models = {
        ...
        u'wardrobe.item': {
            ...
            'default_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wardrobe.ImageUpload']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
