...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPrefs.public_wardrobe'
        db.add_column(u'wardrobe_userprefs', 'public_wardrobe',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPrefs.public_wardrobe'
        db.delete_column(u'wardrobe_userprefs', 'public_wardrobe')
    ...
    models = {
        ...
        u'wardrobe.userprefs': {
            ...
            'public_wardrobe': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
