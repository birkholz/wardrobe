...
urlpatterns = patterns('',
    ...
    url(r'^set_default_image/(?P<item_id>\d+)/(?P<uuid>\w+)/$', 'wardrobe.ajax.set_default_image', name='set_default_image'),
    ...
    url(r'^password_reset/done/$', 'django.contrib.auth.views.password_reset_done', {'template_name': 'forms-wholepage/password_reset_done.html'}, name='password_reset_done'),
    url(r'^reset/(?P<uidb36>[0-9A-Za-z]{1,13})-(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
        'django.contrib.auth.views.password_reset_confirm', {'template_name': 'forms-wholepage/password_reset_confirm.html'},
        name='password_reset_confirm'),
    url(r'^reset/done/$', 'django.contrib.auth.views.password_reset_complete', {'template_name': 'forms-wholepage/password_reset_complete.html'}, name='password_reset_complete'),
